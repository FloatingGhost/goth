...
See https://github.com/floatingghost/goth/blob/master/examples/main.go to see this in action.
*/
package gothic
...
See https://github.com/floatingghost/goth/examples/main.go to see this in action.
*/
